...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        private void InitializeComponent()
        {
            ...
            txt_pronounciationAdd.TextChanged += Txt_pronounciationAdd_TextChanged;
            txt_pronounciationRegex.TextChanged += Txt_pronounciationRegex_TextChanged;
            txt_spellingAdd.TextChanged += Txt_spellingAdd_TextChanged;
            txt_spellingRegex.TextChanged += Txt_spellingRegex_TextChanged;
            txt_tPronounciationAdd.TextChanged += Txt_tPronounciationAdd_TextChanged;
            txt_tSpellingAdd.TextChanged += Txt_tSpellingAdd_TextChanged;
            txt_fPronounciationAdd.TextChanged += Txt_fPronounciationAdd_TextChanged;
        ...
        private void Txt_pronounciationRegex_TextChanged(object? sender, EventArgs e)
        {
            AffixRulesChanged = true;
            Changed?.Invoke(this, EventArgs.Empty);
        }

        private void Txt_pronounciationAdd_TextChanged(object? sender, EventArgs e)
        {
            AffixRulesChanged = true;
            Changed?.Invoke(this, EventArgs.Empty);
        }
        ...
        private void Txt_tPronounciationAdd_TextChanged(object? sender, EventArgs e)
        {
            AffixRulesChanged = true;
            Changed?.Invoke(this, EventArgs.Empty);
        }
        ...
        private void Txt_fPronounciationAdd_TextChanged(object? sender, EventArgs e)
        {
            AffixRulesChanged = true;
            Changed?.Invoke(this, EventArgs.Empty);
        }
